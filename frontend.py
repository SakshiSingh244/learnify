...
from database import save_roadmap, get_user_roadmaps  # Import functions
...
def main():
    ...
    if selected_roadmap != "None":
        ...
        roadmap_id, _, subject, topics_json, progress_json = selected_data
        st.session_state["roadmap"] = json.loads(topics_json)
